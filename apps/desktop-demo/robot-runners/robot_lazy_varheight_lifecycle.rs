...
//! Validates that lifecycle matches JC when fewer/more items fit due to size variations.
//!
//! Run with:
//! ```bash
    ...
    AppLauncher::new()
        ...
        .with_test_driver(|robot| {
            ...
            if let Some((c, e, d)) = read_stats() {
                ...
                // 2. Disposes > 0 (items were disposed)
                assert!(d > 0, "Items should be disposed when scrolling");

                // 3. Total composes should show recomposition
