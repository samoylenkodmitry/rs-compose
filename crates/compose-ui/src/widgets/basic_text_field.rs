...
/// Options for customizing BasicTextField appearance.
...
pub struct BasicTextFieldOptions {
    ...
    pub read_only: bool,
    /// Single line mode (no newlines allowed)
...
pub fn BasicTextFieldWithOptions(
    ...
    let text_field_element = TextFieldElement::new(state).with_cursor_color(options.cursor_color);
