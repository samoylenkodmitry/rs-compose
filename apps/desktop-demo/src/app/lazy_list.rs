...
pub fn lazy_list_example() {
    ...
    Column(
        ...
        move || {
            ...
            // ISOLATED first_visible_item_index display for testing reactivity
            // This is in a SEPARATE composition scope from stats() to test whether
            // first_visible_item_index() itself creates a proper snapshot dependency.
            // If it doesn't, this text will NOT update when scrolling.
            Row(
                Modifier::empty().fill_max_width(),
                RowSpec::new().horizontal_arrangement(LinearArrangement::Start),
                move || {
